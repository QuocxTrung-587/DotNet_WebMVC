            ...
            modelBuilder.Entity("News_website.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RequestedDate = new DateTime(2023, 11, 30, 15, 54, 15, 475, DateTimeKind.Local).AddTicks(718)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            RequestApproved = true,
                            RequestedBy = "StoreOwner",
                            RequestedDate = new DateTime(2023, 11, 30, 15, 54, 15, 475, DateTimeKind.Local).AddTicks(729)
                        },
                        new
                        {
                            Id = 3,
                            ...
                            RequestApproved = true,
                            RequestedBy = "StoreOwner",
                            RequestedDate = new DateTime(2023, 11, 30, 15, 54, 15, 475, DateTimeKind.Local).AddTicks(731)
                        },
                        new
                        {
                            Id = 4,
                            ...
                            RequestApproved = true,
                            RequestedBy = "StoreOwner",
                            RequestedDate = new DateTime(2023, 11, 30, 15, 54, 15, 475, DateTimeKind.Local).AddTicks(732)
                        });
                });
